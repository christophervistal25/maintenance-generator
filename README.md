...
A powerful Laravel package to generate a complete module (Controller, Model, View, and Migration) with a single artisan command. Streamline your development workflow and maintain consistency across your application.
...
- Make the options available in the create and edit views
...
Specify a custom path for your module files:

```bash
php artisan make:module Payment --path="Modules/Billing"
```
...
The generated controllers include validation for select fields and pass the options to views:
...
In your Blade views, you can use the passed options to create dropdowns:
